...
(function () {
  ...
  function cityVisualHTML() {
    if (lesson?.id === "family") return `<section class="a1-family-tree-visual"><h3>${esc(({ru:"Семейное дерево",uk:"Родинне дерево",en:"Family tree",es:"Árbol familiar"})[lang()]||"Family tree")}</h3><p class="a1-family-caption">tío/tía = hermano/a de mi padre o madre · primo/a = hijo/a de mi tío o tía</p><div class="a1-family-chart"><div class="family-pair"><b>👴 abuelo</b><span>+</span><b>👵 abuela</b></div><i>↓</i><div class="family-branches"><article><b>👨‍🦱 tío</b><small>hermano de mi padre</small><i>↓</i><b>👦 primo</b></article><article><b>👨 padre</b><span>+</span><b>👩 madre</b><i>↓</i><div><b>👦 hermano</b><strong>🙂 yo</strong><b>👧 hermana</b></div></article></div></div><div class="a1-family-nephew"><b>👦 hermano / 👧 hermana</b><i>↓</i><b>👶 sobrino / sobrina</b></div></section>`;
