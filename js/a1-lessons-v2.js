...
(function () {
  ...
  function cityVisualHTML() {
    if (lesson?.id === "family") return `<section class="a1-family-tree-visual"><h3>${esc(({ru:"Семейное дерево",uk:"Родинне дерево",en:"Family tree",es:"Árbol familiar"})[lang()]||"Family tree")}</h3><div class="a1-family-generations"><article><span>👴</span><b>abuelo</b></article><article><span>👵</span><b>abuela</b></article><i>↓</i><article><span>👨</span><b>padre</b></article><article><span>👩</span><b>madre</b></article><i>↓</i><article><span>👦</span><b>hermano</b></article><article><span>🙂</span><b>yo</b></article><article><span>👧</span><b>hermana</b></article></div><div class="a1-family-extra"><article><span>👨‍🦱</span><b>tío</b></article><article><span>👩</span><b>tía</b></article><i>→</i><article><span>👶</span><b>sobrino / sobrina</b></article></div></section>`;
